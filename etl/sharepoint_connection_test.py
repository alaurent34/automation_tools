...
# It will return a URL, go to this in a browser, accept the permissions, then paste in the URL you
# are redirected to
...
dl_path='./download_folder'
f_name='myfile.xlsx'

print("Connecting to O365")
account = Account(
    credentials=(registered_app_name, registered_app_secret),
