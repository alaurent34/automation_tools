...
client_id = 'bf6b60c5-7b63-40dd-8f77-b12ad54f275b'  # Your client_id
client_secret = 'Pw98Q~BqJkWQHcNN4G3MtLBVz04JdsKxHpi9Eczb' # Your client_secret, create an (id, secret) at https://apps.dev.microsoft.com
tenant_id = '0df30cf8-8dc5-44d3-8596-88ad266ccfa8'

hostname = 'statdemtl.sharepoint.com'
collection_id = 'ba00c095-37e9-4784-8ee9-1865ffa89289'
site_id = 'befb5108-c702-44b1-8fef-3e70694995d3'

CHUNK_SIZE = 1024 * 1024 * 5

class O365Sharepoint():
    """Handle files in sharepoint
    """
    def __init__(self, account, site_id=None):

        self.account = account
        self.sharepoint = Sharepoint(account)
        if site:
            self.site = self.get_site(site_id)
        else:
            self.site = self.get_root_site()
